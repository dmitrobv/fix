    ...
    <body>
        <div class="header">
            ...
            <div class="cat_descriptions">
                ...
                <p id="cat3_descr">Квартира и дом</p>
                <p id="cat4_descr">Электричество</p>
                <p id="cat5_descr">Полезные советы</p>
                <p id="cat6_descr">Всё мобильное</p>
                <p id="cat7_descr">Инструменты</p>
                <p id="cat8_descr">Компьютеры</p>
